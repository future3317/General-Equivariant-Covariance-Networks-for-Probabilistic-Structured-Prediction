...
def _geometry_descriptors(cache: Path, *, view_id: int) -> dict[str, torch.Tensor]:
...
def main() -> None:
    ...
    descriptors = {
        "test": _geometry_descriptors(args.side_geometry, view_id=0),
        "ood": _geometry_descriptors(args.top_geometry, view_id=1),
    }
